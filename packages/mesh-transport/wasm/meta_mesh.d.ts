...
export class WasmStateCore {
    ...
    static hasConflictingBreakGlassClaims(records: any): boolean;
    ...
    static summarizeSuccession(policy: any, claims: any, votes: any, transfers: any, break_glass_claims: any, revocations: any, epoch: number): any;
...
export interface InitOutput {
    ...
    readonly wasmstatecore_hasConflictingBreakGlassClaims: (a: any) => [number, number, number];
    ...
    readonly wasmstatecore_summarizeSuccession: (a: any, b: any, c: any, d: any, e: any, f: any, g: number) => [number, number, number];
