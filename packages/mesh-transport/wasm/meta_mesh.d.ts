...
export class WasmMeshAuthenticatedSessions {
    ...
    clear(): void;
    constructor();
    peer(remote_endpoint: string): any;
    refresh(snapshot: any, now_ms: number): any;
    remove(remote_endpoint: string): boolean;
}
...
export interface InitOutput {
    ...
    readonly wasmmeshauthenticatedsessions_peer: (a: number, b: number, c: number) => [number, number, number];
    readonly wasmmeshauthenticatedsessions_refresh: (a: number, b: any, c: number) => [number, number, number];
    readonly wasmmeshauthenticatedsessions_remove: (a: number, b: number, c: number) => number;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h06074dae60d40542: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h0668d83804d7811e: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__ha593547b4b4d4073: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5e2917d87bff6ccd: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h28fa48acdd215434: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h4ae76659b6917bed: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h28fa48acdd215434_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h28fa48acdd215434_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5bb40ed414a5757f: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h47c8c9f25a39602b: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h4e8bf84e1cf91c76: (a: number, b: number) => void;
