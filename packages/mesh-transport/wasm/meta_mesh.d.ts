...
export class WasmMeshRuntimeState {
    ...
    clearGossipNeighbors(workspace_id: string): void;
    ...
    constructor();
    observeGossipNeighbors(workspace_id: string, count: number): any;
...
export class WasmStateCore {
    ...
    static preferredSessionDirection(local_device_id: string, remote_device_id: string): any;
...
export interface InitOutput {
    ...
    readonly wasmstatecore_preferredSessionDirection: (a: number, b: number, c: number, d: number) => [number, number, number];
    ...
    readonly wasmmeshruntimestate_clearGossipNeighbors: (a: number, b: number, c: number) => void;
    ...
    readonly wasmmeshruntimestate_observeGossipNeighbors: (a: number, b: number, c: number, d: number) => [number, number, number];
