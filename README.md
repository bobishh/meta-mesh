...
See [Quint formal verification and MBT](quint/README.md) for specifications of replica delivery and gossip convergence, counterexample evidence, and state-space exploration.
